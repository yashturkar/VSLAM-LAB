...
from vslamlab_utilities import run_exp, evaluate_exp, compare_exp, eval_metrics, eval_metrics_single, eval_baselines, demo_single, write_demo_yaml_fles
...
if __name__ == "__main__":
    if len(sys.argv) > 1:
        ...
        if function_name == "eval_baselines":
            config_yaml = sys.argv[2]
            eval_baselines(config_yaml)
